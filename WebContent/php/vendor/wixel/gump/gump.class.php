		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_valid_name':
					$resp[] = "The <span class=\"$field_class\">$field</span> field should contain a valid name";
					break;
		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_alpha_dash':
					...
					break;
				case 'validate_numeric':
					$resp[$field] = "The $field field should contain valid number";
					break;
				case 'validate_integer':
				...
				case 'validate_valid_cc':
					...
					break;
				case 'validate_valid_name':
					$resp[$field] = "The $field field needs to contain a valid name";
					break;
				case 'validate_contains':
